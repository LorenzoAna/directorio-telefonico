...
describe('ContactService', () => {
  ...
  describe('getContactsByUserId()', () => {
    it('Debe devolver los contactos del usuario registrado', () => {
  ...
  describe('addNewContact()', () => {
    it('Debe añadir un nuevo contacto y crear una relación', () => {
      const baseUrl: string = 'http://localhost:3000';
      const formValue = {
        name: 'Contact00',
        lastName: 'None',
  ...
  describe('deleteContact()', () => {
    it('Debe borrar un contacto si no hay relaciones que existan', () => {
      const baseUrl: string = 'http://localhost:3000';
      const contactId = '1';
      const userId = '123';
      const mockRelation = [
        { id: '1', user_id: userId, contact_id: contactId },
      ];
  ...
  describe('getContactById()', () => {
    it('Debe devolver un contacto por su ID', () => {
      const baseUrl: string = 'http://localhost:3000';
      const contactId = '1';
      const mockContact: Contact = {
        id: '1',
